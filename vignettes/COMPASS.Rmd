...
representing a population of cells drawn from a particular sample. Each row is a
cell, each column is a marker, and each cell is an intensity measure associated
with a particular cell and cytokine. Only cells that have expressed at least one
marker are included.
