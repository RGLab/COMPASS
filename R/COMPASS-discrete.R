.COMPASS.discrete <- function(n_s, n_u, categories, iterations, replications, lambda_s, lambda_u, verbose=TRUE, ...) {
  ...
  ## these lambdas can be user-defined
  ## hyper-parameter for alpha_s, alpha_u
  ## alpha ~ exp(lambda)
  #lambda_s = rep(0,K);  
